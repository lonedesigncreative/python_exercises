...
## What it is:  
`math.pi` is a **constant** in the Python `math` module that represents the mathematical value of **π (pi)**.

>> “The number π, approximately 3.141592653589793.”
...
It is:
- **irrational** (infinite decimal places)
- **non‑repeating**
- used in geometry, trigonometry, physics, engineering
...
> - It is the **standard** in scientific and mathematical code
> 
> Typing `3.14` is okay for school math, but not for programming.
...
**Example - Common uses of math.pi**
