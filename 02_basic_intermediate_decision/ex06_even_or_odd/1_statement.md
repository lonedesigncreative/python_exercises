...
- **If the remainder of the division by 2 is equal to 0**, the program should indicate that the number is even.
- **Otherwise**, it should inform the user that the number is odd.