...
- **Only works inside case patterns** → outside match/case, it becomes bitwise OR.
- **Types must match** → `"3"` is not the same as `3`.
...
This will display:
- *"A" | "B" | "C"* → if the value is any of these, the case matches.
