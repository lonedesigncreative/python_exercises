...
>
> 4. ` option = int(input("Enter an option: "))` 
...
>
> 6. `case 1: print("You selected option 1")`
> - If the user typed 1, this message is printed.
>
> 7. `case 2: print("You selected option 2")`
> - If the user typed 2, this message is printed.
> 8. `case 3: print("You selected option 3")`
> - If the user typed 3, this message is printed.
> 9. `case 4: print("You selected option 4")`
...
> 
> 11. `case 1: print("You selected option 1")`
> - If the user typed 1, this message is printed.
>
> 12. `case _: print("Invalid option")`
