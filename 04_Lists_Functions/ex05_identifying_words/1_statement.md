...
- To achieve this, you should use the **min** and **max** functions together with the parameter `key=len`, so that the comparison is based on word length rather than alphabetical order.